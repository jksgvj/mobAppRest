...
public class Burgers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.kurica).setOnClickListener(v -> showChickenBurgerDialog());
        findViewById(R.id.govyadina).setOnClickListener(v -> showBeefBurgerDialog());
        findViewById(R.id.svinina).setOnClickListener(v -> showPorkBurgerDialog());
        findViewById(R.id.egg).setOnClickListener(v -> showEggBaconBurgerDialog());
    ...
    private void showBurgerDialog(String title, String description, int imageRes, int price, String[] nutrition) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        View dialogView = getLayoutInflater().inflate(R.layout.burger_dialog, null);
        builder.setView(dialogView);

        // Настройка содержимого
        ImageView burgerImage = dialogView.findViewById(R.id.burger_image);
        TextView titleView = dialogView.findViewById(R.id.burger_title);
        TextView descView = dialogView.findViewById(R.id.burger_description);
    ...
    // Конкретные методы для каждого бургера
    public void showChickenBurgerDialog() {
        String[] nutrition = {"223 ккал", "11,7 г", "10,3 г", "21,6 г"};
        showBurgerDialog(
                "Бургер с курицей",
                "В составе куриная котлета со свежими овощами и фирменным соусом",
                R.drawable.burger4,
                200,
                nutrition
        );
    ...
    public void showBeefBurgerDialog() {
        String[] nutrition = {"295 ккал", "15,2 г", "18,5 г", "22,1 г"};
        showBurgerDialog(
                "Бургер с говядиной",
                "В составе говяжья котлета с сыром Чеддер, луком и соусом",
                R.drawable.burger5,
                220,
                nutrition
        );
    ...
    public void showPorkBurgerDialog() {
        String[] nutrition = {"275 ккал", "13,8 г", "16,2 г", "20,4 г"};
        showBurgerDialog(
                "Бургер со свининой",
                "В составе свиная котлета с копченым беконом и барбекю соусом",
                R.drawable.burger3,
                190,
                nutrition
        );
    ...
    public void showEggBaconBurgerDialog() {
        String[] nutrition = {"310 ккал", "14,5 г", "19,8 г", "23,7 г"};
        showBurgerDialog(
                "Бургер с яйцом и беконом",
                "В составе бекон, яйцо-пашот, свежие овощи и голландский соус",
                R.drawable.burger,
                180,
                nutrition
        );
